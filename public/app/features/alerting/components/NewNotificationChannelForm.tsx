      ...
      <div className={styles.basicSettings}>
        ...
        {currentFormValues.uploadImage && !imageRendererAvailable && (
          <InfoBox title="No image renderer available/installed">
            Grafana cannot find an image renderer to capture an image for the notification. Please make sure the Finvezt
            Image Renderer plugin is installed. Please contact your Finvezt administrator to install the plugin.
          </InfoBox>
        )}
        <Field
